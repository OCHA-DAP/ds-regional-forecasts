...
**ACMAD** (continental Long-Range Forecasts, ACCOF statements, RCOF outputs),
**AGRHYMET** (PRESASS and PRESAGG forums), and the **SADC Climate Services
Centre** (SARCOF forum statements back to 2002, objective seasonal forecast
maps), assembled so regional consensus products can be viewed together and
...
- `src/datasources/` — scrapers: ACMAD THREDDS catalog crawler, AGRHYMET
  WordPress media harvest, SADC/CSC Drupal crawlers + objective-forecast image
  prober, Wayback Machine rescues for dead-site PDFs, and the
